...
.start
{
    ; Refuse to run on a second processor.
    ; TODO: This could potentially be allowed (by setting load/exec addresses to
    ; the host) now we don't try to re-enter the code on BREAK.
